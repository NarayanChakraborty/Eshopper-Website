			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Items From Your Selected Subcategory</h2>
						<?php
						...
						<?php
						$brand_product=$db->prepare('select * from tbl_products where p_cat_id=? and p_subcat_id=?');
						$brand_product->execute(array($cat_id,$subcat_id));
